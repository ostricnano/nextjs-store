//quiere decir que cada accion que se corra va a estar del lado del servidor
// los servers actions son funciones que se corren del lado del servidor
// no regresan una respuesta como lo haria un endpoint pero si pueden retornar un valor
"use server"
